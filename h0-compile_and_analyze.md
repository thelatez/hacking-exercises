...
Pointtina se, että esimerkiksi salasanat tai API-avaimet eivät ole kovin turvallisessa tilassa binäärissä, vaikka niitä ei välttämättä tule ikinä käyttöön koko ohjelman suorittamisen aikana. 
